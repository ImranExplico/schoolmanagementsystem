            ...
            <form method="GET" class="d-block ajaxForm" action="{{ route('admin.syllabus.syllabus_list') }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 pt-2">
                        <button class="btn btn-block btn-secondary mt-4" type="submit" id = "filter_routine">{{ get_phrase('Filter') }}</button>
                    </div>

                </div>
            </form>

            <div class="table-responsive class_routine_content">
                <table id="basic-datatable" class="table eTable">
                    ...
                    <tbody>
                        <?php $syllabuses = Syllabus::where(['class_id' => $class_id, 'section_id' => $section_id, 'session_id' => $active_session->id,'school_id' => auth()->user()->school_id])->get();
