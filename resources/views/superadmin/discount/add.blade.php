            ...
            >
                <div class="d-flex flex-column">
                    ...
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        ...
                        <li><a href="#">{{ get_phrase('Add Discount') }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-12">
        <div class="eSection-wrap">
			...
			<div class="eMain">
				<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('superadmin.discount.create') }}">
					@csrf 
					<div class="row">
							...
							<div class="eForm-layouts">
								...
								<div class="fpb-7">
									...
									<div class="custom-control custom-radio">
			                            <input type="radio" name="discount_type" value="1" class="present" checked required> {{ get_phrase('Percentage') }} &nbsp;
			                            <input type="radio" name="discount_type" value="2" class="absent" required> {{ get_phrase('Value') }}
				                    </div>
								</div>
								<div class="fpb-7">
									<label for="discount_rule" class="eForm-label">{{ get_phrase('Single/Multiple') }}</label>
									<div class="custom-control custom-radio">
			                            <input type="radio" name="discount_rule" value="1" class="present" checked required> {{ get_phrase('Single') }} &nbsp;
			                            <input type="radio" name="discount_rule" value="2" class="absent" required> {{ get_phrase('Multiple') }}
				                    </div>
								</div>
								<div class="fpb-7">
									<label for="discount_amount" class="eForm-label">{{ get_phrase('Discount Amount') }}</label>
									<input type="number" class="form-control eForm-control" id="discount_amount" name="discount_amount" required>
								</div>
								<div class="fpb-7">
									<label for="frequency" class="eForm-label">{{ get_phrase('Frequency') }}</label>
									<div class="custom-control custom-radio">
			                            <input type="radio" name="frequency" value="1" class="present" checked required> {{ get_phrase('Monthly') }} &nbsp;
			                            <input type="radio" name="frequency" value="2" class="absent" required> {{ get_phrase('Once') }}
				                    </div>
								</div>
								<div class="fpb-7">
									<label for="status" class="eForm-label">{{ get_phrase('Status') }}</label>
									<div class="custom-control custom-radio">
			                            <input type="radio" name="status" value="1" class="present" checked required> {{ get_phrase('Active') }} &nbsp;
			                            <input type="radio" name="status" value="0" class="absent" required> {{ get_phrase('Inactive') }}
				                    </div>
								</div>
							</div>
						</div>
								...
								<div class="fpb-7">
									...
									<select name="enrolment_year" id="enrolment_year" class="form-select eForm-select">
					                    ...
					                    @foreach($enrolment_years as $enrolment_year)
					                    	<option value="{{$enrolment_year->id}}">{{$enrolment_year->session_title}}</option>
					                    @endforeach
					                </select>
								</div>
								<div class="fpb-7">
					...
					<div class="row mt-3">
						...
						<div class="col-md-6 pb-3">
							<div class="eForm-layouts">
								<div class="fpb-7">
									<input type="checkbox" name="earliest_commencement_date_check" id="earliest_commencement_date" value="1">
									<label for="earliest_commencement_date" class="eForm-label">{{ get_phrase('Earliest Commencement Date')}}</label>
									<div class="col-md-12">
										<input type="text" class="form-control daterange-commencement eForm-control" name="earliest_commencement_date" value="{{ date('m/d/Y').' - '.date('m/d/Y') }}" />
									</div>
									<!--
									<div class="row"> 
										<div class="col-md-6">
								...
								<div class="fpb-7">
									<input type="checkbox" name="course_commencement_date_check" id="course_commencement_date" value="1">
									<label for="course_commencement_date" class="eForm-label">{{ get_phrase('Course Commencement Date')}}</label>
									<div class="col-md-12">
										<input type="text" class="form-control daterange-commencement eForm-control" name="course_commencement_date" value="{{ date('m/d/Y').' - '.date('m/d/Y') }}" />
									</div>
									<!-- <div class="row">
										<div class="col-md-6">
								...
								<div class="fpb-7">
									<input type="checkbox" name="invoice_commencement_date_check" id="invoice_commencement_date" value="1">
									<label for="invoice_commencement_date" class="eForm-label">{{ get_phrase('Invoice Date')}}</label>
									<div class="col-md-12">
										<input type="text" class="form-control daterange-commencement eForm-control" name="invoice_commencement_date" value="{{ date('m/d/Y').' - '.date('m/d/Y') }}" />
									</div>
									<!-- <div class="row">
										<div class="col-md-6">
								...
								<div class="fpb-7">
									...
									<textarea class="form-control eForm-control" id="remarks" name="remarks" rows="5" required></textarea>
								</div>
							</div>
						</div>
					</div>
