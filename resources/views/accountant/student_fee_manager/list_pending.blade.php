            ...
            @foreach($invoices as $invoice)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <small> <strong>{{ get_phrase('Class') }} :</strong> {{ $student_details['class_name'] }}</small>
                    </td>
                    <td>
                        {{ $invoice['title'] }}
                    </td>
                    ...
                    <td class="link"> <a href="{{ asset('public/assets/uploads/offline_payment/'.$invoice['document_image']) }}" download> {{ $invoice['document_image'] }} </a></td>
                    <td>
