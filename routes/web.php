...
Route::get('superadmin/classrooms/{school_id}',[SuperAdminController::class, 'getClassRooms'])->name('superadmin.getclassrooms');
...
Route::controller(SuperAdminController::class)->middleware('auth','superAdmin')->group(function () {
    ...
    //Branch Class rooms
    Route::get('superadmin/school/classrooms/list/{schoolId}', 'schoolClassroomList')->name('superadmin.school.classroom.list');
    Route::get('superadmin/class_room/{id}', 'editClassRoom')->name('superadmin.edit.class_room');
    Route::post('superadmin/class_room/{id}', 'classRoomUpdate')->name('superadmin.class_room.update');
    Route::get('superadmin/class_room_create/{schoolId}', 'createClassRoom')->name('superadmin.class_room.open_modal');
    Route::post('superadmin/class_room', 'classRoomCreate')->name('superadmin.create.class_room');
    Route::get('superadmin/class_room/delete/{id}', 'classRoomDelete')->name('superadmin.class_room.delete');
    ...
    //Depertment routes
    Route::get('superadmin/department', 'departmentList')->name('superadmin.department_list');
    Route::get('superadmin/department_create', 'createDepartment')->name('superadmin.department.open_modal');
    Route::post('superadmin/department', 'departmentCreate')->name('superadmin.create.department');
    Route::get('superadmin/department/{id}', 'editDepartment')->name('superadmin.edit.department');
    Route::post('superadmin/department/{id}', 'departmentUpdate')->name('superadmin.department.update');
    Route::get('superdmin/department/delete/{id}', 'departmentDelete')->name('superadmin.department.delete');
    ...
    //Session routes
    Route::get('superadmin/session_manager', 'sessionManager')->name('superadmin.settings.session_manager');
    Route::get('superadmin/session_manager/active_session/{id}', 'activeSession')->name('superadmin.session_manager.active_session');
    Route::get('superadmin/session_manager/create', 'createSession')->name('superadmin.create.session');
    Route::post('superadmin/session_add', 'sessionCreate')->name('superadmin.session_manager.create');
    Route::get('superadmin/session_manager/{id}', 'editSession')->name('superadmin.edit.session');
    Route::post('superadmin/session_manager/{id}', 'sessionUpdate')->name('superadmin.session.update');
    Route::get('superadmin/session_manager/delete/{id}', 'sessionDelete')->name('superadmin.session.delete');

    // Settings discount routes

    Route::get('superadmin/settings/discount_manager', 'discountManager')->name('superadmin.settings.discount_manager');
    Route::get('superadmin/settings/discount/add', 'discountAdd')->name('superadmin.discount.add');
    Route::post('superadmin/settings/discount/create', 'createDiscount')->name('superadmin.discount.create');
    Route::get('superadmin/settings/discount_manager/{id}', 'editDiscount')->name('superadmin.discount.edit');
    Route::post('superadmin/settings/discount/update', 'updateDiscount')->name('superadmin.discount.update');
    Route::get('superadmin/settings/discount/delete/{id}', 'discountDelete')->name('superadmin.discount.delete');
});
