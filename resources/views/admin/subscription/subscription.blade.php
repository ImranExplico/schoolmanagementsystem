					...
					<div>
						<p>
		                	<span class="float-left">
		                		<h4>{{ get_phrase($package_details['name']) }}</h4>
		                	</span>
						</p>
						<span class="interval">
		                	<?php if($package_details['interval'] == 'Days'): ?>
		                		{{ get_phrase($package_details['days'].' '.$package_details['interval']) }}
		                	<?php else: ?>
		                		{{ get_phrase($package_details['interval']) }}
		                	<?php endif; ?>
		                </span>
...
<div class="row">
    <div class="col-12">
        <div class="eSection-wrap">
        	...
        	<form method="GET" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.subscription', ['date_form' => $date_from, 'date_to' => $date_to]) }}">
            	<div class="row">
