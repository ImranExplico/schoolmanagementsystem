    ...
    <div class="col-12">
        <div class="eSection-wrap">
        	<div class="title">
				...
				<p>{{get_phrase('Provide all the information required for your school.')}}</p>
			</div>
					...
					<div class="row">
						<div class="col-md-6 pb-3">
							<div class="eForm-layouts">
								...
								<div class="fpb-7">
									<label for="school_code" class="eForm-label">{{ get_phrase('School Code') }}</label>
									<input type="text" class="form-control eForm-control" id="school_code" name="school_code" required>
								</div>
								<div class="fpb-7">
								...
								<div class="fpb-7">
									<label for="postal_code" class="eForm-label">{{ get_phrase('Postal Code') }}</label>
									<input type="text" class="form-control eForm-control" id="postal_code" name="postal_code" required>
								</div>
								<div class="fpb-7">
								...
								<div class="fpb-7">
									...
									<input type="number" class="form-control eForm-control" id="school_phone" name="school_phone" required>
								</div>
								<div class="fpb-7">
						...
						<div class="col-md-6 pb-3">
							<div class="eForm-layouts">
								{{-- <p class="column-title">{{ get_phrase('ADMIN') }}</p> --}}
								<div class="fpb-7">
					                <label for="status" class="eForm-label">{{ get_phrase('Branch Status') }}</label>
						...
						{{-- <div class="col-md-6 pb-3">
							<div class="eForm-layouts">
								...
								<div class="fpb-7">
									...
									<input type="number" name="admin_phone" class="form-control eForm-control" id="admin_phone" required>
								</div>
								<div class="fpb-7">
