      ...
      <li class="nav-links-li {{ request()->is('librarian/dashboard') ? 'showMenu':'' }}">
        <div class="iocn-link">
          <a href="{{ route('librarian.dashboard') }}">
			...
			<!-- Sidebar menu -->
			<li class="nav-links-li {{ request()->is('librarian/book*') || request()->is('librarian/book_issue*') ? 'showMenu':'' }}">
                <div class="iocn-link">
                    <a href="#">
                        <div class="sidebar_icon">
                ...
                <ul class="sub-menu">
                    <li><a class="{{ (request()->is('librarian/book/list')) ? 'active' : '' }}" href="{{ route('librarian.book.book_list') }}"><span>
                                {{ get_phrase('Book List Manager') }}
                            </span></a></li>
                    <li><a class="{{ (request()->is('librarian/book_issue')) ? 'active' : '' }}" href="{{ route('librarian.book_issue.list') }}"><span>
          ...
          <li class="nav-links-li {{ request()->is('hr/leave_list*') || request()->is('attendence/list*')  || request()->is('payment/list*')  ? 'showMenu':'' }}">
            ...
            <ul class="sub-menu">
              ...
              <li>
                <a class="{{ (request()->is('he/leave_list*')) ? 'active' : '' }}" href="{{ route('hr.list_of_leaves') }}">
