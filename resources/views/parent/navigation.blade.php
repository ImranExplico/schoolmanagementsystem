      ...
      <li class="nav-links-li {{ request()->is('parent/dashboard') ? 'showMenu':'' }}">
        <div class="iocn-link">
          <a href="{{ route('parent.dashboard') }}">
			...
			<li class="nav-links-li {{ request()->is('parent/attendence/list*') || request()->is('parent/noticeboard*') || request()->is('parent/routine*') || request()->is('parent/child/syllabus*')|| request()->is('parent/child/subjects*') || request()->is('student/syllabus*') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
              ...
              />
				...
				<ul class="sub-menu">
                    ...
                    <li><a class="{{ (request()->is('parent/child/subjects*')) ? 'active' : '' }}" href="{{ route('parent.subject_list') }}"><span>{{ get_phrase('Subjects') }}</span></a></li>
                     ...
                     <li><a class="{{ (request()->is('parent/noticeboard*')) ? 'active' : '' }}" href="{{ route('parent.noticeboard.list') }}"><span>{{ get_phrase('Noticeboard') }}</span></a></li>
                    </ul>
			</li>
            ...
            <li class="nav-links-li {{ request()->is('parent/fee_manager*')  ? 'showMenu':'' }}">
                ...
                <ul class="sub-menu">
                    <li><a class="{{ (request()->is('parent/fee_manager*')) ? 'active' : '' }}" href="{{ route('parent.fee_manager.list') }}"><span>
