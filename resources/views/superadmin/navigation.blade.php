...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/css/jquery.datetimepicker.css?v=1') }}" />
    <link rel="stylesheet" href="{{ asset('public/assets/css/jquery.timepicker.min.css') }}" />
...
<body>
      ...
      <li class="nav-links-li {{ request()->is('superadmin/dashboard') ? 'showMenu':'' }}">
        <div class="iocn-link">
          <a href="{{ route('superadmin.dashboard') }}">
			...
			<li class="nav-links-li {{ request()->is('superadmin/school/list*') || request()->is('superadmin/school/add*') || request()->is('superadmin/school/pending*') || request()->is('superadmin/class_list*') || request()->is('superadmin/department*') || request()->is('superadmin/school/classrooms/list*') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
						...
						<span class="link_name">{{ get_phrase('General Setup') }}</span>
					</a>
					<span class="arrow">
            <svg
            ...
            >
              ...
              />
				...
				<ul class="sub-menu">
					<li><a class="{{ (request()->is('superadmin/school/list*') || request()->is('superadmin/school/classrooms/list*')) ? 'active' : '' }}" href="{{ route('superadmin.school.list') }}"><span>{{ get_phrase('Schools') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/class_list*')) ? 'active' : '' }}" href="{{ route('superadmin.class_list') }}"><span>{{ get_phrase('Levels') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/department*')) ? 'active' : '' }}" href="{{ route('superadmin.department_list') }}"><span>{{ get_phrase('Subjects') }}</span></a></li>
				</ul>
			</li>
			...
			<li class="nav-links-li {{ request()->is('superadmin/subject*') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a class="{{ (request()->is('superadmin/subject*')) ? 'active' : '' }}" href="{{ route('superadmin.subject_list') }}">
						<div class="sidebar_icon">
							<svg id="Layer_1" height="48px" viewBox="0 0 24 24" width="48px" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"><path d="m5 11.5a1.5 1.5 0 0 1 1.5-1.5h11a1.5 1.5 0 0 1 0 3h-11a1.5 1.5 0 0 1 -1.5-1.5zm1.5 6.5h7a1.5 1.5 0 0 0 0-3h-7a1.5 1.5 0 0 0 0 3zm17.5-11.5v11a5.506 5.506 0 0 1 -5.5 5.5h-13a5.506 5.506 0 0 1 -5.5-5.5v-11a5.506 5.506 0 0 1 5.5-5.5h13a5.506 5.506 0 0 1 5.5 5.5zm-16-2a1.5 1.5 0 1 0 1.5-1.5 1.5 1.5 0 0 0 -1.5 1.5zm-5 0a1.5 1.5 0 1 0 1.5-1.5 1.5 1.5 0 0 0 -1.5 1.5zm18 3.5h-18v9.5a2.5 2.5 0 0 0 2.5 2.5h13a2.5 2.5 0 0 0 2.5-2.5z"/></svg>
						</div>
			...
			<li class="nav-links-li {{ request()->is('superadmin/subscription/report*') || request()->is('superadmin/subscription/pending*') || request()->is('superadmin/subscription/approve*') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a href="#">
						...
						<span class="link_name">{{ get_phrase('Payment Setup') }}</span>
					</a>
					<span class="arrow">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              />
				...
				<ul class="sub-menu">
					<li><a class="{{ (request()->is('superadmin/subscription/report*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.report') }}"><span>{{ get_phrase('Registeration Fee') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/subscription/pending*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.pending') }}"><span>{{ get_phrase('Deposits') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/subscription/approve*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.approve') }}"><span>{{ get_phrase('Material Fee') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/subscription/report*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.report') }}"><span>{{ get_phrase('Course Fee') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/subscription/pending*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.pending') }}"><span>{{ get_phrase('Discount') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/subscription/approve*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.approve') }}"><span>{{ get_phrase('Vouchers') }}</span></a></li>
				</ul>
			</li>
			<!-- <li class="nav-links-li {{ request()->is('superadmin/subscription/report*') || request()->is('superadmin/subscription/pending*') || request()->is('superadmin/subscription/approve*') ? 'showMenu':'' }}">
				<div class="iocn-link">
			...
			<li class="nav-links-li {{ request()->is('superadmin/subscription/report*') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a class="{{ (request()->is('superadmin/subscription/report*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.report') }}">
						<div class="sidebar_icon">
						...
						<span class="link_name">{{ get_phrase('Merchandise') }}</span>
					</a>
				</div>
			</li>
			<li class="nav-links-li {{ request()->is('superadmin/subscription/report*') || request()->is('superadmin/subscription/pending*') || request()->is('superadmin/subscription/approve*') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a href="#">
						...
						<span class="link_name">{{ get_phrase('System Users') }}</span>
					</a>
					<span class="arrow">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              />
				...
				<ul class="sub-menu">
					<li><a class="{{ (request()->is('superadmin/subscription/report*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.report') }}"><span>{{ get_phrase('Role') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/subscription/pending*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.pending') }}"><span>{{ get_phrase('Access Right') }}</span></a></li>
					<li><a class="{{ (request()->is('superadmin/subscription/approve*')) ? 'active' : '' }}" href="{{ route('superadmin.subscription.approve') }}"><span>{{ get_phrase('Users') }}</span></a></li>
				</ul>
			</li>
			...
			<li class="nav-links-li {{ request()->is('superadmin/settings/system*') || request()->is('superadmin/payment/settings*') || request()->is('superadmin/settings/smtp*') || request()->is('superadmin/session_manager*') || request()->is('superadmin/settings/discount*') || request()->is('superadmin/settings/about*') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="48" height="48">
            ...
            >
              ...
              />
				...
				<ul class="sub-menu">
					<li><a class="{{ (request()->is('superadmin/session_manager*')) ? 'active' : '' }}" href="{{ route('superadmin.settings.session_manager') }}"><span>{{ get_phrase('Sessions') }}</span></a></li>
					...
					<!-- <li><a class="{{ (request()->is('superadmin/settings/discount*')) ? 'active' : '' }}" href="{{ route('superadmin.settings.discount_manager') }}"><span>{{ get_phrase('Discount') }}</span></a></li> -->
    ...
    <script src="{{ asset('public/assets/js/jquery.datetimepicker.js?v=1') }}"></script>
    ...
    <script src="{{ asset('public/assets/js/actions.js') }}"></script>
