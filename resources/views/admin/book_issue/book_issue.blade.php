    ...
    <div class="col-12">
        <div class="eSection-wrap">
            <div class="row mb-3">
                ...
                <form method="GET" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.book_issue.list') }}">
                    <div class="row">
                        <div class="row justify-content-md-center">
                            ...
                            <div class="col-md-2 export position-relative">
                ...
                <div class="book_issue_content" id="book_issue_report">
