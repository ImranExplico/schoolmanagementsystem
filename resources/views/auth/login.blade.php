            ...
            <div class="middle-elem">
                <div class="primary-form">
                    <div class="form-logo mb-5">
                        <img height="60px" src="{{ asset('public/assets/uploads/logo/'.get_settings('dark_logo')) }}">
                    </div>
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            <div class="w-100 d-flex justify-content-end">
                                                ...
                                                <a href="https://creativeitem.zendesk.com/" target="_blank" class="float-end me-1">{{ get_phrase('Help') }}</a>
                                            </div>
                                        </div>
