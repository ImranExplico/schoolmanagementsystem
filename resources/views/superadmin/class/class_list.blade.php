      ...
      <div class="col-12">
        ...
        >
          ...
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('{{ route('superadmin.class.open_modal') }}', '{{ get_phrase('Create Level') }}')">{{ get_phrase('Add level') }}</a>
          </div>
        </div>
      </div>
    </div>
                                ...
                                <td class="text-start">
                                    <div class="adminTable-action">
                                        ...
                                        >
                                          ...
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="rightModal('{{ route('superadmin.edit.class', ['id' => $class_list->id]) }}', '{{ get_phrase('Edit Level') }}')">{{ get_phrase('Edit Level') }}</a>
                                          </li>
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="confirmModal('{{ route('superadmin.class.delete', ['id' => $class_list->id]) }}', 'undefined');">{{ get_phrase('Delete') }}</a>
                                          </li>
                                        </ul>
                                    </div>
                                </td>
