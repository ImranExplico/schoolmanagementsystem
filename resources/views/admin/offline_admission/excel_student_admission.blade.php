    ...
    <div class="row justify-content-md-center">
        <div class="col-xl-4">
            <select name="class_id" id="class_id" class="form-select eForm-select eChoice-multiple-with-remove" onchange="classWiseSection(this.value)" required>
                ...
                @foreach($data['classes'] as $class)
                    <option value="{{ $class->id }}">{{ get_phrase($class->name) }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-4 p-1">
                <div class="col-12">
                    <a href="{{ asset('public/assets/csv_file/student.generate.csv') }}" class="btn btn-success btn-sm" download>Generate csv file <i class="bi bi-download"></i> </a>
