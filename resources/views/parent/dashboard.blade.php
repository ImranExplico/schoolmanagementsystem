...
@section('content')   
                   ...
                   <div class="col-md-6">
                     <div class="dashboard_ShortListItem">
                       ...
                       >
                         ...
                         <a href="#" class="ds_link ds_sutdent">
                           <svg
                       ...
                       >
                         ...
                         <div class="ds_item_icon">
                           <img
                             src="{{ asset('public/assets/images/Student_icon.png') }}"
                             alt=""
                           />
                         </div>
                       </div>
                   ...
                   <div class="col-md-6">
                     <div class="dashboard_ShortListItem">
                       ...
                       >
                         ...
                         <a href="#" class="ds_link ds_teacher">
                           <svg
                             xmlns="http://www.w3.org/2000/svg"
                             width="10.146"
                             height="4.764"
                       ...
                       >
                         ...
                         <div class="ds_item_icon">
                           <img
                             src="{{ asset('public/assets/images/Teacher_icon.png') }}"
                             alt=""
                           />
                         </div>
                       </div>
                     ...
                     <div class="dashboard_ShortListItem">
                       ...
                       >
                         <div class="ds_item_details">
                           ...
                           <h4 class="total_no">{{ $accountant + $librarian }}</h4>
   ...
   <!-- Resources -->
   <script src="{{asset('public/assets/amchart/index.js')}}"></script>
   <script src="{{asset('public/assets/amchart/xy.js')}}"></script>
   <script src="{{asset('public/assets/amchart/animated.js')}}"></script>
